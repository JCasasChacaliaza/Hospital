...
SET ANSI_NULLS ON
GO
CREATE VIEW [dbo].[vw_medicos]
AS
SELECT        MEDICO.MEDICO.NOMMED, MEDICO.MEDICO_ESPECIALIDAD.DESCESP, MEDICO.ESPECIALIDAD.NOMESP, MEDICO.ESPECIALIDAD.OBSESP
...
Begin DesignProperties = 
   ...
   End
End
', 'SCHEMA', N'dbo', 'VIEW', N'vw_medicos', NULL, NULL
GO
DECLARE @xp int
SELECT @xp=1
EXEC sp_addextendedproperty N'MS_DiagramPaneCount', @xp, 'SCHEMA', N'dbo', 'VIEW', N'vw_medicos', NULL, NULL
GO
